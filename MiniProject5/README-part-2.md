...
8. make sure to have `build_network.py` updated to include `overwrite_config=True` so we can rerun. dont forget to add comma on line above to avoid syntax error
